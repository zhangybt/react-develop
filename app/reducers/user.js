...
export const userSearchResult = handleActions({
...
export const userSearchQuery = handleActions({
  'update user search query'(state, action) {
    return { ...state, ...action.payload }
  },
  'reset user search query'(state, action) {
